...
def generateDataAugmentation(train_all_subjectsListOfCODEsList_LIST, CCS_ordered_internalCodesMap, reverse_CCS_ordered_internalCodesMap, localDiagnosisCCSToICD9, originalDiagnosisICD9_Codes):
...
def makeDataAugmentation(train_all_subjectsListOfCODEsList_LIST, originalDiagnosisICD9_Codes, CCS_ordered_internalCodesMap, reverse_CCS_ordered_internalCodesMap):
	icd9TOCCS_Map  = pickle.load(open(sys.path[0]+'/icd9_to_css_dictionary','rb'))
	...
	new_train_all_subjectsListOfCODEsList_LIST = generateDataAugmentation(train_all_subjectsListOfCODEsList_LIST, CCS_ordered_internalCodesMap, reverse_CCS_ordered_internalCodesMap, localDiagnosisCCSToICD9, originalDiagnosisICD9_Codes)

	# Adding the other method	
	onlyTwoAdmissionsPatients = []
	for patient_admissions in new_train_all_subjectsListOfCODEsList_LIST:
	...
	new_train_all_subjectsListOfCODEsList_LIST = new_train_all_subjectsListOfCODEsList_LIST + onlyTwoAdmissionsPatients
	
	return new_train_all_subjectsListOfCODEsList_LIST