...
from mimic_augmentation_final_create import makeDataAugmentation
...
if __name__ == '__main__':
	...
	for subject_id, hadmList in subjectTOhadms_Map.iteritems():
		...
		sortedList = sorted([(hadmTOadmttime_Map[hadm_id], hadmToICD9CODEs_Map[hadm_id], hadm_id) for hadm_id in hadmList] ,reverse = False)
	...
	# call data augmentation techniques
	new_all_subjectsListOfCODEsList_LIST = makeDataAugmentation(new_all_subjectsListOfCODEsList_LIST)
