...
from incor_aumentation_local import makeDataAugmentation
...
if __name__ == '__main__':
	...
	print("total_patients_dumped: ", total_patients_dumped)
	...
	new_all_subjectsListOfCODEsList_LIST = makeDataAugmentation(proportion, new_all_subjectsListOfCODEsList_LIST, actionOrderedIndexesMAP, reverse_ordered_internalCodesMap)
	random.shuffle(new_all_subjectsListOfCODEsList_LIST)
	# Write train data
	...
	print '   Success, file length: ' + str(index_of_last_patient_to_dump)
	total_patients_dumped += index_of_last_patient_to_dump #- index_of_first_patient_to_dump
	print("total_patients_dumped: ", total_patients_dumped)
