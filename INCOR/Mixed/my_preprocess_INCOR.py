...
from incor_aumentation_mix import makeDataAugmentation
...
if __name__ == '__main__':
	...
	new_all_subjectsListOfCODEsList_LIST = makeDataAugmentation(new_all_subjectsListOfCODEsList_LIST, actionOrderedIndexesMAP, reverse_ordered_internalCodesMap)
